...
**/
export const RegiCommonButton2: React.FC<TextTopProps> = ({ children, text, inputText }) => (
    <View style={{flex:2, marginTop:deviceHeight*0.03, flexDirection:"row"}}> 
...
**/
export const RegiNextButton: React.FC<ButtonProps> = ({ children, text, onPress }) => (
<View style={{flex:4, justifyContent:"flex-start", alignItems:"center"}}>
    <TouchableOpacity onPress={onPress} style={longButtonStyle.longButtonStyle}><Text style={textStyle.textbase}>{text}</Text>{children}</TouchableOpacity>
</View>);