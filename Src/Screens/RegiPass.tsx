...
import { RegiText2, RegiNextButton } from "../Components/CommonView/CommonCompo";
...
const RegiPass: React.FC<ScreenProps> = ({ navigation }) => {
  ...
  return (
    <LoginBackground>
        ...
        <RegiNextButton text="다음" onPress={() => navigation.navigate("AccountLoginRegi")} navigation={navigation}/>                         
    </LoginBackground>
  );
};
