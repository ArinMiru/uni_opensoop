...
import { RegiText2, RegiCommonButton2, RegiNextButton } from "../Components/CommonView/CommonCompo";
...
const RegiNmNic: React.FC<ScreenProps> = ({ navigation }) => {
  ...
  return (
    <LoginBackground>
        ...
        <RegiNextButton text="다음" onPress={() => navigation.navigate("RegiPass")} navigation={navigation}/>                         
    </LoginBackground>
  );
};
